...
// definition of the startBattle() which controls the game itself
function startBattle() {
	...
	let action = window.prompt("You are walking through the forest minding your own business and a troll suddenly appears\n\nDo you FIGHT the troll?\n\nDo you RUN from the troll?\n\nDo you try to BRIBE the troll?").toUpperCase();
...
function fightBattle() {
	...
	// If statement that analyze the responses
...
} // end of the fightBattle() function
...
function bribeBattle() {
	...
	if(money ==="YES") {
		...
		// try to convert the inout to an integer value
		...
		document.getElementById("button").textContent = "Play Again?";
			...
			// user had money, just not the correct amount
